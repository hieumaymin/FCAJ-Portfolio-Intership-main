...
2. [Chuẩn bị môi trường](4.2-Prerequiste/)
3. [Tạo và cấu hình Knowledge Base](4.3-Knowledge-Base/)
4. [Kiểm tra Chatbot (RAG)](4.4-Test-Chatbot/)
5. [Tích hợp ứng dụng Client (Tùy chọn)](4.5-Client-Integration/)
6. [Cập nhật dữ liệu](4.6-Cleanup/)
